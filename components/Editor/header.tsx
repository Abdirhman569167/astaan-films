    ...
    <header className="border-b border-gray-100 bg-white shadow-sm flex items-center justify-between px-6 py-3">
      <div className="flex items-center space-x-6">
        ...
        <div className="hidden md:flex items-center">
          ...
          <span className="text-xl font-bold ml-1">Films</span>
        </div>
      ...
      <div className="hidden md:flex relative max-w-md w-full mx-4">
        ...
        <Input 
          placeholder="Search tasks, messages, or projects..." 
          ...
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="relative h-9 w-9 rounded-full p-0 border-2 border-[#ff4e00]/20 hover:border-[#ff4e00]/50 transition-all duration-200">
              <Avatar className="h-full w-full">
                ...
                <AvatarFallback className="bg-[#ff4e00]/10 text-[#ff4e00] font-medium">U</AvatarFallback>
              </Avatar>
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="end" className="w-56 p-2 border border-gray-100 shadow-lg rounded-xl">
            <div className="flex items-center gap-3 p-2 mb-1">
              <Avatar className="h-10 w-10 border-2 border-[#ff4e00]/20">
                <AvatarImage src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=32&h=32&fit=crop&crop=face" alt="User" />
                <AvatarFallback className="bg-[#ff4e00]/10 text-[#ff4e00]">U</AvatarFallback>
              </Avatar>
              <div>
